...
# from eeglearn import utils
from eeglearn.utils import augment_EEG, cart2sph, pol2cart,reformatInput
...
def sample(data):
    ...
    print('Loading data...juhiu')
    # print('hsy')
    locs = scipy.io.loadmat('/content/gdrive/MyDrive/ASCERTAIN_Dataset/topo/EEGLearn/Sample data/Neuroscan_locs_orig.mat')
    locs_3d = locs['A']
    ...
    feats = scipy.io.loadmat('/content/gdrive/MyDrive/ASCERTAIN_Dataset/topo/EEGLearn/Sample data/FeatureMat_timeWin.mat')
    feats = feats['features']
    print(feats)
    subj_nums = np.squeeze(scipy.io.loadmat('/content/gdrive/MyDrive/ASCERTAIN_Dataset/topo/EEGLearn/Sample data/trials_subNums.mat')['subjectNum'])
    ...
    temp = [feats[:, i*192:(i+1)*192] for i in range(feats.shape[1] // 192)]
    av_feats = reduce(lambda x, y: x+y,temp)
